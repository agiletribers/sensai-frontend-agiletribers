...
export default function TaskTypeMetricCard({
    ...
    return (
        <div className={`relative overflow-hidden bg-gradient-to-br from-[#ffffff] to-[#f8f8f8] rounded-xl border border-transparent hover:${colorMap[color].border} transition-colors group`}>
            ...
            <div className="relative p-6 flex flex-col">
                <div className="flex justify-between items-start mb-3">
                    ...
                    <div className="text-3xl xl:text-4xl font-light text-black">
                        {completionPercentage}%
                    </div>
                </div>

                <div className="text-xs text-gray-800">{count} task{count === 1 ? '' : 's'}</div>

                {/* Progress bar */}
                <div className="h-2 w-full bg-gray-400/70 rounded-full overflow-hidden mt-2">
                    <div
