...
export default function CreateCourseDialog({
    ...
    return (
        <div className="fixed inset-0 bg-ffffff bg-opacity-70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div
                className="w-full max-w-md bg-[#f8f8f8] rounded-lg shadow-2xl"
                    ...
                    <div className="space-y-4">
                        <div>
                            <input
                                ...
                                className={`w-full px-4 py-3 bg-[#f1f1f1] text-black text-lg rounded-lg font-light placeholder-gray-500 outline-none ${error ? 'border border-red-500' : 'border-none'}`}
                                disabled={isLoading}
                            />
                            {error && (
